...
const GroupInitiative = (() => { // eslint-disable-line no-unused-vars
    ...
    const statAdjustments = {
        ...
        'token_bar': {
            ...
            desc: 'Takes the bonus from the numbered bar on the token. Use 1, 2, or 3.  Defaults to 0 in the absence of a number.'
        },
        ...
        'token_bar_max': {
            ...
            desc: 'Takes the bonus from the max value of the numbered bar on the token. Use 1, 2, or 3.  Defaults to 0 in the absence of a number.'
        },
        'token_aura': {
            type: adjustments.TOKEN,
            func: function(t,idx) {
            ...
            desc: 'Takes the bonus from the radius of the token aura. Use 1 or 2.  Defaults to 0 in the absence of a number.'
        }
